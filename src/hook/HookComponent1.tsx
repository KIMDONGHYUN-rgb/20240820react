...
// - usecCallback : 메모리 내에서 함수를 재사용할 수 있도록 하는 함수, 렌더링없이 특정 함수를 실행할 수 있게 함
...
export default function HookComponent1() {
    ...
    // - 개발 실행 환경에서는 mount = unmount가 한번 실행되고난 후 다시 mount됨
    ...
    // 스코프할 상태 배열에 상태를 지정하면 지정한 상태가 바뀔떄 마다 함수가 호출됨
    useEffect(() => {
        // 스코프할 상태 배열에 따라
        // setState1(state1 + 1);
